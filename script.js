...
// COMPREHENSIVE QUESTION POOL - 400+ QUESTIONS (FIXED VERSION)
const questionPool = [
  ...
  {
    desc: "Format partition /dev/sdb1 as ext4.",
    points: 15,
  ...
  {
    desc: "Format partition /dev/sdb2 as xfs.",
    points: 15,
    cmds: ["mkfs.xfs /dev/sdb2"],
    verify: ["blkid /dev/sdb2"],
    hint: "mkfs.xfs creates XFS filesystem",
  },
  {
    desc: "Check filesystem on /dev/sdb1.",
    points: 15,
    cmds: ["fsck /dev/sdb1"],
  ...
  {
    desc: "Mount filesystem /dev/sdb1 to /mnt/data.",
    points: 10,
  ...
  {
    desc: "Unmount filesystem from /mnt/data.",
    points: 10,
  ...
  {
    desc: "Mount /dev/sdb1 with specific options: noatime,nodiratime.",
    points: 15,
  ...
  {
    desc: "Show directory space usage of /var.",
    points: 10,
    cmds: ["du -sh /var"],
    verify: ["du -sh /var"],
  ...
  {
    desc: "Add entry for /dev/sdb1 to /etc/fstab for auto-mount at boot.",
    points: 20,
  ...
  {
    desc: "Test fstab entries by mounting all.",
    points: 15,
    cmds: ["mount -a"],
    verify: ["mount | grep /mnt/data"],
  ...
  {
    desc: "Find filesystem UUID of /dev/sdb1.",
    points: 10,
    cmds: ["blkid /dev/sdb1"],
    verify: ["blkid /dev/sdb1"],
  ...
  {
    desc: "Mount filesystem by UUID instead of device name.",
    points: 15,
  ...
  {
    desc: "Create swap partition on /dev/sdb2.",
    points: 20,
  ...
  {
    desc: "Create swap file /swapfile with size 1GB.",
    points: 25,
    cmds: [
  ...
  {
    desc: "Remove swap file /swapfile.",
    points: 20,
  ...
  {
    desc: "Resize ext4 filesystem on /dev/sdb1.",
    points: 25,
  ...
  {
    desc: "Create physical volume on /dev/sdb.",
    points: 15,
  ...
  {
    desc: "Create volume group vg_data on /dev/sdb.",
    points: 15,
  ...
  {
    desc: "Create logical volume lv_home with size 10G.",
    points: 20,
  ...
  {
    desc: "Create LV lv_var using all free space in VG.",
    points: 20,
  ...
  {
    desc: "Extend volume group vg_data with /dev/sdc.",
    points: 20,
  ...
  {
    desc: "Reduce volume group vg_data by removing /dev/sdc.",
    points: 25,
  ...
  {
    desc: "Extend logical volume lv_home by 5G.",
    points: 25,
  ...
  {
    desc: "Reduce logical volume lv_home to 8G.",
    points: 30,
    cmds: [
      "umount /home",
  ...
  {
    desc: "Remove logical volume lv_home.",
    points: 20,
  ...
  {
    desc: "Remove volume group vg_data.",
    points: 20,
  ...
  {
    desc: "Remove physical volume /dev/sdb from LVM.",
    points: 20,
  ...
  {
    desc: "Create snapshot of lv_home named snap_home (1G).",
    points: 30,
  ...
  {
    desc: "Restore from snapshot snap_home.",
    points: 35,
    cmds: [
      "umount /home",
  ...
  {
    desc: "Remove snapshot snap_home.",
    points: 20,
  ...
  {
    desc: "Activate volume group vg_data.",
    points: 15,
  ...
  {
    desc: "Deactivate volume group vg_data.",
    points: 15,
  ...
  {
    desc: "Rename volume group vg_data to vg_new.",
    points: 20,
  ...
  {
    desc: "Rename logical volume lv_old to lv_new.",
    points: 20,
  ...
  {
    desc: "Move data from physical volume /dev/sdb to other PVs.",
    points: 30,
    cmds: ["pvmove /dev/sdb"],
    verify: ["pvs"],
  ...
  {
    desc: "Set physical extent size to 16M when creating VG.",
    points: 20,
  ...
  {
    desc: "Create striped logical volume (2 stripes, 64K stripe size).",
    points: 25,
  ...
  {
    desc: "Create mirrored logical volume (1 mirror copy).",
    points: 30,
  ...
  {
    desc: "Create thin pool thinpool (100G) and thin volume thinvol (10G).",
    points: 35,
    cmds: [
  ...
  {
    desc: "Case-insensitive search for 'Error' in file.txt.",
    points: 10,
  ...
  {
    desc: "Search for whole word 'word' in file.txt.",
    points: 10,
  ...
  {
    desc: "Count occurrences of 'error' in file.txt.",
    points: 10,
  ...
  {
    desc: "Show line numbers with matches for 'error' in file.txt.",
    points: 10,
  ...
  {
    desc: "Find files containing 'pattern' in current directory.",
    points: 15,
  ...
  {
    desc: "Find files larger than 100MB in root filesystem.",
    points: 15,
  ...
  {
    desc: "Find empty files in current directory.",
    points: 10,
  ...
  {
    desc: "Sort file.txt alphabetically.",
    points: 10,
    cmds: ["sort file.txt"],
  ...
  {
    desc: "Sort numbers.txt numerically.",
    points: 10,
  ...
  {
    desc: "Sort file.txt in reverse order.",
    points: 10,
  ...
  {
    desc: "Remove duplicate lines from file.txt.",
    points: 10,
  ...
  {
    desc: "Extract first column from CSV file.csv.",
    points: 15,
  ...
  {
    desc: "Extract characters 1-10 from each line in file.txt.",
    points: 15,
  ...
  {
    desc: "Count lines, words, characters in file.txt.",
    points: 10,
    cmds: ["wc file.txt"],
    verify: ["wc file.txt"],
  ...
  {
    desc: "Count lines only in file.txt.",
    points: 10,
    cmds: ["wc -l file.txt"],
  ...
  {
    desc: "Replace 'old' with 'new' in file.txt.",
    points: 15,
  ...
  {
    desc: "Replace 'old' with 'new' in file.txt in place.",
    points: 20,
  ...
  {
    desc: "Print lines 10-20 of file.txt.",
    points: 10,
  ...
  {
    desc: "Delete lines containing 'pattern' from file.txt.",
    points: 15,
  ...
  {
    desc: "Print first 10 lines of file.txt.",
    points: 10,
  ...
  {
    desc: "Print last 10 lines of file.txt.",
    points: 10,
  ...
  {
    desc: "Add system cron job for root user.",
    points: 25,
  ...
  {
    desc: "Add cron job to /etc/cron.d/ directory.",
    points: 25,
  ...
  {
    desc: "View details of at job number 1.",
    points: 15,
    cmds: ["at -c 1"],
  ...
  {
    desc: "Run job every hour on weekdays (Monday-Friday).",
    points: 20,
  ...
  {
    desc: "Run job every 10 minutes during business hours (9am-5pm, Mon-Fri).",
    points: 25,
  ...
  {
    desc: "Add MAILTO to crontab for email notifications.",
    points: 20,
  ...
  {
    desc: "Add PATH to crontab for command search.",
    points: 20,
  ...
  {
    desc: "Run job on specific months (January, June, December).",
    points: 20,
  ...
  {
    desc: "Schedule job to run on system reboot.",
    points: 20,
  ...
  {
    desc: "View logs for httpd service.",
    points: 15,
  ...
  {
    desc: "Clear journal logs older than 2 days.",
    points: 20,
  ...
  {
    desc: "Enable persistent journal storage.",
    points: 20,
  ...
  {
    desc: "Add custom log rule to rsyslog for local1 facility.",
    points: 25,
  ...
  {
    desc: "Set system time to 2024-01-15 14:30:00.",
    points: 20,
  ...
  {
    desc: "Show timezone information.",
    points: 10,
    cmds: ["timedatectl"],
  ...
  {
    desc: "Configure NTP server to time.server.com.",
    points: 30,
    cmds: [
  ...
  {
    desc: "Check NTP synchronization status.",
    points: 15,
  ...
  {
    desc: "Check chrony tracking information.",
    points: 15,
  ...
  {
    desc: "View log rotation configuration.",
    points: 15,
  ...
  {
    desc: "Pull nginx container image from Docker Hub.",
    points: 15,
  ...
  {
    desc: "Run nginx container in detached mode.",
    points: 20,
  ...
  {
    desc: "Run container with port mapping 8080:80.",
    points: 25,
  ...
  {
    desc: "Run container with volume mapping.",
    points: 25,
  ...
  {
    desc: "Inspect container details.",
    points: 15,
  ...
  {
    desc: "Commit container to new image.",
    points: 25,
  ...
  {
    desc: "Build image from Dockerfile in current directory.",
    points: 30,
  ...
  {
    desc: "Save nginx image to tar file.",
    points: 20,
  ...
  {
    desc: "Create pod mypod with port mapping 8080:80.",
    points: 30,
  ...
  {
    desc: "Run container in pod mypod.",
    points: 30,
  ...
  {
    desc: "Generate systemd service file for container.",
    points: 35,
  ...
  {
    desc: "Enable container as systemd user service.",
    points: 35,
  ...
  {
    desc: "Prune unused containers and images.",
    points: 25,
  ...
  {
    desc: "Search man pages for 'useradd' keyword.",
    points: 10,
    cmds: ["man -k useradd"],
  ...
  {
    desc: "Display man page section 5 for passwd.",
    points: 15,
    cmds: ["man 5 passwd"],
    verify: ["man 5 passwd"],
  ...
  {
    desc: "Quick man page lookup for ls.",
    points: 10,
    cmds: ["whatis ls"],
    verify: ["whatis ls"],
  ...
  {
    desc: "Use command completion (press Tab twice).",
    points: 10,
  ...
  {
    desc: "Search history for 'apt' commands.",
    points: 10,
  ...
  {
    desc: "Re-run command by history number 123.",
    points: 15,
    cmds: ["!123"],
    verify: ["!123"],
  ...
  {
    desc: "Create tmux session named mysession.",
    points: 20,
  ...
  {
    desc: "Detach from tmux session (Ctrl+b then d).",
    points: 15,
    cmds: ["# Ctrl+b then d"],
    verify: ["tmux list-sessions"],
  ...
  {
    desc: "Attach to tmux session mysession.",
    points: 15,
  ...
  {
    desc: "Split tmux pane horizontally (Ctrl+b then \").",
    points: 20,
    cmds: ["# Ctrl+b then \""],
  ...
  {
    desc: "Split tmux pane vertically (Ctrl+b then %).",
    points: 20,
    cmds: ["# Ctrl+b then %"],
    verify: ["# Should split window"],
  ...
  {
    desc: "Switch tmux pane (Ctrl+b then arrow key).",
    points: 15,
  ...
  {
    desc: "Verify service status before submission.",
    points: 15,
    cmds: ["systemctl --failed"],
    verify: ["systemctl --failed"],
  ...
  {
    desc: "Verify user/group assignments.",
    points: 15,
    cmds: ["id username"],
    verify: ["id username"],
  ...
  {
    desc: "Test network connectivity to 8.8.8.8.",
    points: 15,
  ...
  {
    desc: "Check time synchronization.",
    points: 15,
    cmds: ["timedatectl status"],
  ...
  {
    desc: "Final verification command before exam submission.",
    points: 20,
